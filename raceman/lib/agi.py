...
class AGI(Component):
	def __init__(self,*args,**kwargs):
		...
		self.Input=File(fd=sys.__stdin__,mode="r", channel="stdin", encoding='utf-8').register(self)
		self.Output=File(fd=sys.__stdout__,mode="w", channel="stdout", encoding='utf-8').register(self)
	...
	@handler('agicommand',channel='agi')
	def _agicommand(self,data):
		self._state=ST_BUSY
		data1=bytearray(data+u"\n",'utf-8')
		#pdb.set_trace()
		self.Output.write(data1)
		#pdb.set_trace()
