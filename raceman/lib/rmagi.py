...
class AGI(Component):
    def __init__(self,*args,**kwargs):
        ...
        self.Input=File(fd=sys.stdin,mode="r", channel="agiinput").register(self)
        self.Output=File(fd=sys.stdout,mode="w", channel="agioutput", encoding="utf-8").register(self)
